...
<head>
    ...
    <title>Space Blog - Sample Post</title>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="index.php">Space Blog</a>
            </div>
    ...
    <?php
            $adr_img = $result[0]['photo'];
            echo "<style>";
            echo ".intro-header {background-image: url('";
            echo $adr_img;
            echo "');";
            echo "}";
            echo "</style>";
    ...
    <header class="intro-header" >
        ...
        echo "</h1>";
            ...
            echo "<span class='meta'>Posted by <a href='#'>";
        echo $article['auteur'];
        echo "</a> on ";
        echo $article['date']; 
        echo "</span>";
